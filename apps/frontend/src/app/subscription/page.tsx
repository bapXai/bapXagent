      ...
      <div className="max-w-6xl mx-auto space-y-8">
        <div className="text-center space-y-4">
          ...
          <p className="text-md text-muted-foreground max-w-2xl mx-auto">
            {isTrialExpired
              ? 'Your 7-day free trial has ended. Choose a plan to continue using bapX AI.'
              : 'A subscription is required to use bapX. Choose the plan that works best for you.'}
          </p>
        </div>
        <Suspense fallback={
          <div className="grid md:grid-cols-3 gap-6">
        ...
        <div className="text-center text-sm text-muted-foreground -mt-10">
          <p>
            ...
            <a href="mailto:support@bapx.com" className="underline hover:text-primary">
              support@bapx.com
            </a>
          </p>
        </div>
