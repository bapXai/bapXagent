...
export const metadata: Metadata = {
  ...
  authors: [{ name: 'bapX Team', url: 'https://www.bapx.com' }],
  creator: 'bapX Team',
  publisher: 'bapX Team',
  ...
  return (
    <html lang="en" suppressHydrationWarning className={`${roobert.variable} ${roobertMono.variable}`}>
      <head>
        ...
        <title>bapX: Your Autonomous AI Worker</title>
        ...
        <meta name="keywords" content="bapX, AI Worker, Agentic AI, Autonomous AI Worker, AI Automation, AI Workflow Automation, AI Assistant, Task Automation" />
        <meta property="og:title" content="bapX: Your Autonomous AI Worker" />
        ...
        <meta property="og:image" content="https://bapx.com/banner.png" />
        <meta property="og:url" content="https://bapx.com" />
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="bapX" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="bapX: Your Autonomous AI Worker" />
        ...
        <meta name="twitter:image" content="https://bapx.com/banner.png" />
        <meta name="twitter:site" content="@bapx" />
        <link rel="canonical" href="https://bapx.com" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              alternateName: ['bapX', 'bapX AI', 'bapX: Your Autonomous AI Worker'],
              url: siteMetadata.url,
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              alternateName: [siteMetadata.name, 'bapX'],
