...
export const AgentAvatar: React.FC<AgentAvatarProps> = ({
  ...
  isbapXDefault: propIsbapXDefault,
  ...
  const isbapX = propIsbapXDefault ?? agent?.metadata?.is_bapx_default;
  ...
  if (!agent && !propIconName && !propIsbapXDefault && agentId) {
    return (
      <div
